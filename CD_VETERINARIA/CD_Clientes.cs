...
namespace CD_VETERINARIA
{
    public class CD_Clientes
    {
        ...
        public DataTable Mostrar()
        {
            ...
            comando.CommandText = "SELECT*FROM CLIENTES";//Instruccion a ejecutar
        ...
        public void Insertar(string nombre, string apellido)
        {
            ...
            comando.CommandText = "INSERT INTO CLIENTES VALUES('" + nombre + "','" + apellido + "')";//Ponemos las variables
        ...
        public void Editar(string nombre, string apellido,int id)//Metodo para editar un registro
        {
            comando.Connection = conexion.AbrirConexion();//Importante abrir la conexion !!!
            comando.CommandText = "UPDATE CLIENTES SET " + @"[NOMBRE] = @NOMBRE, [APELLIDO] = @APELLIDO " +  @" WHERE [ID] = @ID";
            comando.CommandType = CommandType.Text;//Tenemos que especificar de nuevo que usamos transact
